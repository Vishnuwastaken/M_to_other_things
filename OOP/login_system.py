...
class MainWindow:
    def __init__(self):
        ...
        self.frame.geometry("450x250")
        # self.lbl_welcome1 = Label(text="dsafdsafdsafdsafdsaf dsaf am")
        self.lbl_welcome = Label(text="Welcome to my first GUI program")

        self.lbl_welcome.pack()
        # self.lbl_welcome1.pack()
